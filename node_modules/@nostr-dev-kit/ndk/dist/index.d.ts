...
declare class NDKUser {
     ...
     */
    static fromNip05(nip05Id: string, ndk?: NDK): Promise<NDKUser | undefined>;
    /**
...
declare class NDKSimpleGroup {
     ...
     * @param opts options
     */
    addUser(user: NDKUser, opts?: AddUserOpts): Promise<{
        addUserEvent: NDKEvent;
        currentUserListEvent?: NDKEvent;
    }>;
     ...
     * @returns
     */
    static generateAddUserEvent(userPubkey: string, groupId: string, alt?: string): NDKEvent;
}
...
export { type EventPointer, type Hexpubkey, type IEventHandlingStrategy, NDKAppHandlerEvent, NDKArticle, type NDKAuthPolicy, type NDKCacheAdapter, type NDKConstructorParams, NDKDVMJobFeedback, NDKDVMJobResult, NDKDVMRequest, NDKDvmJobFeedbackStatus, type NDKDvmParam, NDKEvent, type NDKEventId, type NDKFilter, type NDKFilterGroupingId, NDKHighlight, NDKKind, NDKList, type NDKListItem, NDKListKinds, NDKNip07Signer, NDKNip46Backend, NDKNip46Signer, NDKNostrRpc, NDKPrivateKeySigner, NDKRelay, NDKRelayAuthPolicies, type NDKRelayConnectionStats, NDKRelayList, NDKRelaySet, NDKRelayStatus, type NDKRelayUrl, NDKRepost, type NDKRpcRequest, type NDKRpcResponse, type NDKSigner, NDKSimpleGroup, NDKSubscription, NDKSubscriptionCacheUsage, type NDKSubscriptionOptions, type NDKTag, NDKTranscriptionDVM, NDKUser, type NDKUserParams, type NDKUserProfile, NDKVideo, Zap as NDKZap, type NDKZapInvoice, type NIP46Method, type Nip46ApplyTokenCallback, type Nip46PermitCallback, type Nip46PermitCallbackParams, type NostrEvent, type Npub, type ProfilePointer, calculateGroupableId, NDK as default, defaultOpts, mergeFilters, profileFromEvent, serializeProfile, zapInvoiceFromEvent };
