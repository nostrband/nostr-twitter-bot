...
var NDKKind = /* @__PURE__ */ ((NDKKind2) => {
  ...
  NDKKind2[NDKKind2["SubscriptorsList"] = 37003] = "SubscriptorsList";
...
var NDKEvent = class _NDKEvent extends import_tseep4.EventEmitter {
  ...
  tag(userOrEvent, marker) {
    ...
    if (userOrEvent instanceof _NDKEvent) {
...
var NDKUser = class _NDKUser {
   ...
   */
  static async fromNip05(nip05Id, ndk) {
...
function disconnect(pool, debug4) {
  debug4 ??= (0, import_debug2.default)("ndk:relay:auth-policies:disconnect");
  return async (relay) => {
...
function signIn({ ndk, signer, debug: debug4 } = {}) {
  debug4 ??= (0, import_debug2.default)("ndk:relay:auth-policies:signIn");
...
var NDKNip07Signer = class {
  ...
  constructor(waitTimeout = 1e3) {
    this.debug = (0, import_debug3.default)("ndk:nip07");
...
var NDK = class extends import_tseep10.EventEmitter {
  ...
  constructor(opts = {}) {
    super();
    this.debug = opts.debug || (0, import_debug4.default)("ndk");
   ...
   * @returns
   */
  async getUserFromNip05(nip052) {
    return NDKUser.fromNip05(nip052, this);
  }
  /**
